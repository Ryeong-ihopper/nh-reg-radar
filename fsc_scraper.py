...
# 여기에 넣는 기준: **별첨으로 기준 문서가 따로 붙어 있는가.**
#   · 별첨 있음  → 개정판이 나오면 같은 문서가 갱신된다 → 개정 추적이 의미 있다
#   · 보도자료뿐 → 개정이 아니라 '새 편'이 따로 발행된다 → 기존 문서를 봐도 안 바뀐다
# 후자(금융위 「특판 예적금 광고 준수 필요사항」, 금감원 「광고 점검결과」 시리즈)는
# 자동 수집 대상이 아니라 output/_reference/ 에 확보만 해 둔다.
